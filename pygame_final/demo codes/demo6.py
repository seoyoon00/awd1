...
def spawn_new_platform(prev_platform_x):
    next_platform_x = 300
...
buttons = pygame.sprite.Group(play_button, how_to_play_button)
...
while running:
    ...
    if playing:
        ...
        if on_top_platform and top_platforms and top_platforms[-1].rect.x == prev_platform_x:
            prev_platform_x = spawn_new_platform(prev_platform_x)
